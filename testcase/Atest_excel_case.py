...
#1）.初始化信息，url，data
    ...
    def test_run(self,case):
        ...
        #     # print("res_line:%s"%res_line)
        #     res_db_line = dict(db_res)[line]
        #     # print("res_db_line:%s"%res_db_line)
        # #验证
...
if __name__ == '__main__':
    ...
    pytest.main(["-s", "Atest_excel_case.py", "--alluredir", report_path])
    ...
    #pytest.main(["-s","Atest_excel_case.py"])
    # 固定headers请求
    # 1.判断headers是否存在，json转义，无需
    # 2.增加Headers
    # 3.增加cookies
